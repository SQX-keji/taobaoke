					...
					<view v-for="(box, i) in category.data" :key="i">
						...
						<view class="list" v-if="box.info.length>0" >
							<view class="box" v-for="(item, i1) in box.info" :key="i1">
								<image  @click="toCategory(item.son_name)" :src="item.imgurl" lazy-load="https://tk.gomyorder.cn/logo.png"></image>
						...
						data: [{
							...
							},
							{
								...
								info: [{
									...
									{
										son_name: '足浴',
										imgurl: 'http://img.haodanku.com/c0af530b81acc58bc8d495b4ce5ad2ab-600'
									}
								]
							}
						]
