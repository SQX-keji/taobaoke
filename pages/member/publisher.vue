...
<script>
	...
	export default {
		...
		methods: {
			...
			authorized() {
				// #ifdef APP-PLUS
				// plug.taobaoOauth({"url": "https://oauth.taobao.com/authorize?response_type=code&client_id=27742632&redirect_uri=https://tk.gomyorder.cn/pages/member/publisher&state=1&view=wap"}, ret => {
				//     console.error(ret);
				...
				// 	"&redirect_uri=https://tk.gomyorder.cn/pages/member/publisher&state=1&view=wap",
				// 	function(res) {
